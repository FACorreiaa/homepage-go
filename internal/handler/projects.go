...
var allProjects = []model.ProjectItem{
	{
		...
		Tagline:      "Private financial command center, web + iPhone",
		Highlights: []string{
			"Holdings, watchlists, allocation with live pricing",
	...
	{Slug: "fandemic", Title: "Fandemic", RoleTag: "Client Work", Description: "Client delivery for a real-time community platform: I built the Go backend — auth, membership, and live group chat over WebSockets — plus client-side product work.", Outcome: "Shipped with an OpenAPI spec so client teams integrated quickly; JWT-secured sessions and PostgreSQL persistence delivered on schedule.", Tags: []string{"Go", "REST API", "WebSocket", "JWT", "PostgreSQL"}, Category: "Backend / Client Work", DisplayGroup: "Client delivery", GithubLink: "Private", HasLiveLink: false, Featured: true, Icon: "FN", LogoAsset: "/assets/static/projects/fandemic-icon.webp", Status: "Delivered", Tagline: "Go backend for a real-time community platform", Highlights: []string{"Group chat over WebSockets with presence", "JWT auth, scoped permissions, hardened endpoints", "OpenAPI spec for fast client integration"}},
