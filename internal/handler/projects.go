...
var allProjects = []model.ProjectItem{
	...
	{Slug: "web-dashboard-mvp", Title: "Web Dashboard MVP", RoleTag: "Client Work", Description: "Responsive, high-performance web dashboard with real-time analytics for enterprise business needs.", Tags: []string{"React", "TypeScript", "Tailwind CSS"}, Category: "Web App", GithubLink: "https://github.com/FACorreiaa", LiveLink: "https://facorreia.com", HasLiveLink: true, Icon: "WD", IconURL: "/assets/static/vendor/devicon/react-original.svg", Status: "Live"},
	{Slug: "financial-services-platform", Title: "Financial Services Platform", RoleTag: "Client Work", Description: "Modular web services for finance sector with Go, Postgres, MSSQL, and GraphQL.", Tags: []string{"Go", "GraphQL", "Postgres", "MSSQL"}, Category: "Backend", GithubLink: "https://github.com/FACorreiaa", HasLiveLink: false, Icon: "FS", Status: "Delivered"},
	{Slug: "network-tracking-app", Title: "Network Tracking App", RoleTag: "Client Work", Description: "Web version of mobile network tracking application using React and Rust with real-time telemetry.", Tags: []string{"React", "Rust", "gRPC", "OTLP"}, Category: "Full Stack", GithubLink: "https://github.com/FACorreiaa", HasLiveLink: false, Icon: "NT", Status: "Delivered"},
	{Slug: "social-learning-platform", Title: "Social Learning Platform", RoleTag: "Client Work", Description: "Cross-platform mobile and web app with React Native and TypeScript, full backoffice configuration.", Tags: []string{"React Native", "TypeScript", "Go"}, Category: "Mobile", GithubLink: "https://github.com/FACorreiaa", HasLiveLink: false, Icon: "SL", Status: "Delivered"},
}
