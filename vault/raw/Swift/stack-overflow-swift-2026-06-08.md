---
source: Stack Exchange API Swift
ingested_at: 2026-06-08T08:08:33Z
type: web
category: Swift
subcategory: stack-overflow-swift
status: uncompiled
---
# Top Voted Swift Questions on Stack Overflow — 2026-06-08
...
**Score:** 1503 | **Answers:** 44 | **Views:** 535054 | **Tags:** ios, objective-c, swift, model-view-controller, uiviewcontroller
...
**Score:** 1143 | **Answers:** 17 | **Views:** 390304 | **Tags:** swift, objective-c
...
## [How to change Status Bar text color in iOS](https://stackoverflow.com/questions/17678881/how-to-change-status-bar-text-color-in-ios)

**Score:** 1096 | **Answers:** 61 | **Views:** 678864 | **Tags:** ios, swift, ios7, statusbar, uistatusbar
...
**Score:** 1022 | **Answers:** 20 | **Views:** 258399 | **Tags:** swift, documentation
...
## [Swift Beta performance: sorting arrays](https://stackoverflow.com/questions/24101718/swift-beta-performance-sorting-arrays)

**Score:** 990 | **Answers:** 9 | **Views:** 120132 | **Tags:** swift, performance, sorting, xcode6, compiler-optimization

I was implementing an algorithm in Swift Beta and noticed that the performance was very poor. After digging deeper I realized that one of the bottlenecks was something as simple as sorting arrays. The relevant part is here: let n = 1000000
...
// start clock here
let y = sort(x)
// stop clock here In C++, a similar operation

---

## [How to iterate a loop with index and element in Swift](https://stackoverflow.com/questions/24028421/how-to-iterate-a-loop-with-index-and-element-in-swift)

**Score:** 979 | **Answers:** 21 | **Views:** 703955 | **Tags:** arrays, swift, enumeration
...
**Score:** 887 | **Answers:** 19 | **Views:** 361580 | **Tags:** swift, xcode, preprocessor, preprocessor-directive

In C/C++/Objective C you can define a macro using compiler preprocessors.
Moreover, you can include/exclude some parts of code using compiler preprocessors. #ifdef DEBUG
    // Debug-only code
#endif Is there a similar solution in Swift?

---

## [Get the length of a String](https://stackoverflow.com/questions/24037711/get-the-length-of-a-string)

**Score:** 846 | **Answers:** 41 | **Views:** 549231 | **Tags:** swift, string
...
## [Split a String into an array in Swift?](https://stackoverflow.com/questions/25678373/split-a-string-into-an-array-in-swift)

**Score:** 844 | **Answers:** 41 | **Views:** 831362 | **Tags:** arrays, swift, string, split
...
var lastName: String? = fullnameArr[1] Also, sometimes users might not have a last name.
...
**Score:** 761 | **Answers:** 19 | **Views:** 325233 | **Tags:** swift, xcode, terminal
