...
source: "https://github.com/addyosmani/agent-skills/blob/main/docs/getting-started.md"
author:
published:
created: 2026-04-21
...
See [skill-anatomy.md](https://github.com/addyosmani/agent-skills/blob/main/docs/skill-anatomy.md) for the full specification.
